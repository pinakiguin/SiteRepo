...
<div class="content">
  <div class="formWrapper-Autofit">
    <h3 class="formWrapper-h3">Website Uploads</h3>

    <Form enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>?AdminUpload"
          method="post">
      <b>Department: </b><br/>
      <input style="width:400px;" type="text" name="Dept" id="Dept"/>
      <select name="Topic">
        <option value="0">0 - Tender</option>
        <option value="1">1 - Recruitment</option>
        <option value="4">4 - Notice Board</option>
      </select>
      <br/>
