...
<body>
  ...
  <div class="content">
    ...
    <form action="" method="post">
      Work Details:<input type="text" class="form-TxtInput" name="txtwork" disabled value="<?php echo $work[0]['WorkDescription'] ?>">
      Expenditure Amount:<input type="text" class="form-TxtInput" name="txtAmount" value="<?php echo $prg[0]['ExpenditureAmount'] ?>">
