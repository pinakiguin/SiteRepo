    ...
    <div class="formWrapper">
      <form method="post" action="<?php echo WebLib::GetVal($_SERVER, 'PHP_SELF'); ?>">
        ...
        <div class="FieldGroup">
          ...
          <input type="text" name="ProjectName" id="ProjectName" placeholder="Name of Projects"/>
        </div>

        <div class="FieldGroup">
          <label for="SchemeName"><strong>Name of Scheme</strong></label><br/>
          <select id="SchemeID" name="SchemeID" data-placeholder="Select Scheme" class="chzn-select">
            <?php
        ...
        <div class="FieldGroup">
          <label for="AlotmentAmount"><strong>Project Allotment Amount</strong></label>
          <input type="text" name="AlotmentAmount" id="AlotmentAmount" placeholder="Project Allotment Amount"/>
        </div>
