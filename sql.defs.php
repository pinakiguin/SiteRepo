  ...
  switch ($ObjectName) {
    ...
    case 'MenuData':
      $SqlDB = 'INSERT INTO `' . MySQL_Pre . 'MenuItems` '
              ...
              . '(\'\', 2, 0, \'Registration\', \'Register.php\', 1),'
              ...
              . '(\'WebSite\', 6, 1, \'Attendance Register\', \'atnd-reg\', 1),'
              . '(\'WebSite\', 7, 1, \'Monthly Performance Report\', \'mpr\', 1),'
              . '(\'WebSite\', 8, 1, \'Website Upload\', \'uploads\', 1),'
              . '(\'WebSite\', 9, 1, \'Manage Users\', \'Users.php\', 1),'
              . '(\'WebSite\',10, 1, \'Helpline\', \'Helpline.php\', 1),'
              . '(\'WebSite\',11, 1, \'Log Out!\', \'login.php?LogOut=1\', 1),'
              . '(\'USER\', 1, 0, \'Home\', \'index.php\', 1),'
              . '(\'USER\', 2, 1, \'User Profile\', \'Profile.php\', 1),'
              . '(\'USER\', 3, 1, \'Manage Menus\', \'MenuACL.php\', 1),'
              . '(\'USER\', 4, 1, \'User Activity\', \'AuditLogs.php\', 1),'
